...
if __name__ == '__main__':
    ...
    for epoch in range(num_epoch):
        ...
        save_image(fake_images,"./cartoon_img/{}-fake_imgs.png".format(epoch+1),nrow=10,normalize=True,scale_each=True)

        real_images = to_img(real_img.cpu().data)
        save_image(real_images, "./cartoon_img/{}-real_imgs.png".format(epoch + 1), nrow=10, normalize=True,scale_each=True)
